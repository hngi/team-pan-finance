...
@section('content')
    <div class=""  role="tabpanel" aria-labelledby="profile-tab">
        ...
        @endif
        <form action="{{ route('expenses.update', $expense->hashed_id) }}" method="post">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <input type="date" name="date" value="{{ old('date', $expense->date->format('Y-m-d')) }}" class="form-control" id="datepicker" placeholder="Date">
                        @error('date')
